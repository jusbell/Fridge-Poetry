...
(function($){
        ...
        $.crSpline.buildSequence = function(pointList) {
                ...
                seq.push(generateExtension( intval(pointList[1]), intval(pointList[0]) ));
                ...
                res.getPos = function (t) {
                        ...
                        var result = {
                                left: interpolate(microT,
                                                intval(seq[segNum][0]),
                                                intval(seq[segNum+1][0]),
                                                intval(seq[segNum+2][0]),
                                                intval(seq[segNum+3][0])) + "px",
                                top: interpolate(microT,
                                                intval(seq[segNum][1]),
                                                intval(seq[segNum+1][1]),
                                                intval(seq[segNum+2][1]),
                                                intval(seq[segNum+3][1])) + "px"
                                };
                        return result;
                };
                return res;
